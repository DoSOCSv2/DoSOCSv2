...
echo "I am about to do the following, with root privileges acquired as needed:"
echo " - Install all required system packages: (yum install gcc git glib2-devel make postgresql-devel python-devel sqlite)"
echo " - Install DoSOCS using pip"
echo " - Prompt for nomos and dependency-check installation"
echo " - Prompt for database install and configuration"

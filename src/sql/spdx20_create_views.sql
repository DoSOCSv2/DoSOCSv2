...
fty.name                        "type",
fil.sha1                        checksum,
coalesce(lic.short_name, 'NOASSERTION') as license_concluded,
pfi.license_comment             license_comments,
coalesce(fil.copyright_text, 'NOASSERTION') as copyright_text,
coalesce(pro.name, 'NOASSERTION') as project_name,
coalesce(pro.homepage, 'NOASSERTION') as project_homepage,
coalesce(pro.uri, 'NOASSERTION') as project_uri,
fil.comment                     "comment",
fil.notice                      notice
from documents doc
...
join identifiers ide on fil.file_id = ide.file_id
...
coalesce(cre1.creator_text, 'NOASSERTION') as supplier,
coalesce(cre2.creator_text, 'NOASSERTION') as originator,
coalesce(pac.download_location, 'NOASSERTION') as download_location,
pac.verification_code           verification_code,
pac.sha1                        checksum,
coalesce(pac.home_page, 'NOASSERTION') as home_page,
pac.source_info                 source_info,
coalesce(lic1.short_name, 'NOASSERTION') as license_concluded,
coalesce(lic2.short_name, 'NOASSERTION') as license_declared,
pac.license_comment             license_comments,
coalesce(pac.copyright_text,'NOASSERTION') as copyright_text,
pac.summary                     summary,

...
class creatorInfo:
    def __init__(self, packagePath, creator = None, creatorComment = None, licenseListVersion = None):	
    ...
    def outputCreatorInfo_RDF(self):
        ...
        if self.creatorComment != None:
            output+= '\t\t<rdfs:comment>' + str(self.creatorComment) + '</rdfs:comment>\n'
        if self.licenseListVersion != None:
            output += '\t\t<licenseListVersion>' + str(self.licenseListVersion) + '</licenseListVersion>\n'
